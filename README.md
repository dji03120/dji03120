...
| :--- | :--- | :---: |
| Engineer Information Processing (정보처리기사) | Human Resources Development Service of Korea | June 2026 |
| SQL Developer (SQLD) | Korea Data Agency | March 2026 |
...
| Platform | Profile |
| :--- | :--- |
| GitHub | [github.com/dji03120](https://github.com/dji03120) |
...
대전에서 (주)에스엔에서 근무중이며, 웹 애플리케이션, 백엔드 서비스, 데이터베이스 중심 시스템과 개발 도구를 만드는 소프트웨어 엔지니어입니다. Python과 JavaScript 기반 서비스, Kotlin Android 개발, 관계형·문서형 데이터베이스, 클라우드 배포 환경을 폭넓게 다룹니다.
...
| 자격증 | 발급 기관 | 취득 시기 |
| :--- | :--- | :---: |
| 정보처리기사 | 한국산업인력공단 | 2026년 6월 |
| SQLD | 한국데이터산업진흥원 | 2026년 3월 |
...
```yaml
Learning / 학습:
  - Database internals & reliable backend API design
  - Android development & security fundamentals
Building / 개발:
  - Concurrency-aware backend systems with deployment & observability
  - Personal portfolio site and homelab services
Exploring / 탐색:
  - Local AI workflows
  - Cloud-native infrastructure
Open To / 구직:
  - Software Engineering / 소프트웨어 엔지니어링
  - Backend Engineering / 백엔드 엔지니어링
  - Full-Stack Engineering / 풀스택 엔지니어링
  - South Korea & United States / 한국 및 미국 포지션
```
